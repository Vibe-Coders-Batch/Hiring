...
.PHONY: help preflight setup deploy seed-admin seed-data destroy local local-db migrate test clean
...
help:
	...
	@echo "  make migrate           Run drizzle migrations against the configured DATABASE_URL"
